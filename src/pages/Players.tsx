...
const players = [
  {
    ...
    image: "https://images.unsplash.com/photo-1628891435855-1b1304726573?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1563292790-4d86b80f89b2?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1501746877-14782df58473?q=80&w=800&auto=format&fit=crop",
    ...
    >
      ...
      <section ref={headerRef} className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <img 
            src="https://images.unsplash.com/photo-1485470379667-8217113e5c12?q=80&w=1920&auto=format&fit=crop" 
            alt="Players Header" 
